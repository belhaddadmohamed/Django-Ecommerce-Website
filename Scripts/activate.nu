...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Sc\Desktop\Projects\Web-Sites\Site3 (Django_Ecommerce)\BelStore'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Sc\Desktop\Projects\Web-Sites\Site3 (Django_Ecommerce)\BelStore\Scripts\deactivate.nu'
